...
<div class="container mb-5" id="refresh-div">
    <div class="justify-content-center text-center">
        ...
        <table class="table table-bordered">
            ...
            $query_admins = "SELECT * from users";
...
if (isset($_POST['block'])) {
    $admintoken = $_POST['block'];
        ...
        $block_query = "UPDATE users SET approval_status='0' WHERE verify_token='$admintoken';";
...
if (isset($_POST['approve'])) {
    $admintoken = $_POST['approve'];
        ...
        $approve_query = "UPDATE users SET approval_status='1' WHERE verify_token='$admintoken';";
